...
//   handles standard precedence: * and / first (left-to-right), then + and -.
 ...
 */
export function checkAnswer(problem: DigitProblem | null, userDigits: number[]): { ok: boolean; result: number } {
