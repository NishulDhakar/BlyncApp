...
import DeductiveBoard from '../features/games/deductive/DeductiveBoard';
import { GameSymbol, Puzzle, checkAnswer, generatePuzzle } from '../features/games/deductive/logic';
...
export default function DeductiveGameScreen() {
            ...
            <SafeAreaView className="flex-1">
                ...
                <View className="flex-row justify-between items-center px-6 py-4 mt-12">
                    ...
                    <View className="items-center bg-surface px-6 py-2 rounded-2xl border-[3px] border-borderDark shadow-[3px_3px_0px_#332A24]">
                        ...
                        <Text className="text-borderDark font-black text-xl">Deductive</Text>
                    </View>
                ...
                <View className="flex-1 justify-center items-center px-4">
                    ...
                    <View className="w-full max-w-[400px] mb-6 flex-row items-center justify-between bg-surfaceLight px-4 py-2 rounded-xl border-2 border-borderDark">
                        <Text className="font-bold text-borderDark uppercase tracking-widest text-xs">Question Timer</Text>
                    ...
                    <Text className="text-center text-textSecondary font-bold mt-12 px-8 leading-6">
                        Complete the Latin Square. Each row and column must contain unique symbols! Target cell is "?"
                    </Text>
                </View>
            </SafeAreaView>
        </View>
